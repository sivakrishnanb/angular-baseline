define(['angularAMD', 'utility/restapi'], function (angularAMD, restapi) {
		angularAMD.factory('$bus', function($http, $dal, $templateCache) {
			var _bus = {};
		    ...
		    _bus.refresh = function(name, args, deferred) {
				$http({method: restapi[args.api].method, url: restapi[args.api].url, params : args.params, data: args.data,  cache: $templateCache}).
