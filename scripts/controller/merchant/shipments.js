define(['app', 'utility/messages'], function (app, messages) {
    app.controller('MerchantShipments', ['$scope', '$bus', 'ngProgress', '$rootScope', '$routeParams', '$constants', '$location', '$timeout','notify', '$localStorage',
                ...
                default:
                    return true;
								...
								$scope.getTitleText = function() {
									if ($routeParams.status=='pending') {
											return messages.headerTitleMerchantShipPending;
									
									}else if ($routeParams.status=='intransit') {
											return messages.headerTitleMerchantShipInTransit;
